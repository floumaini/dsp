...
FT: Having a fraternal twin P (FT)= 1/125
IT: Having an identical twin P(IT) = 1/300
E: Having a male twin brother
P(E|IT) = 1
P(E|FT) = 1/2

We're looking at 
P(IT|E) = P(E,IT)P(IT)/P(E) = (1/300)/((1/300)*1)+((1/125)*(1/2)) = 0.4545 
